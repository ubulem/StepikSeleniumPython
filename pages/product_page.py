...
class ProductPage(BasePage):
    ...
    def should_not_be_success_message(self):
        assert self.is_not_element_present(
            *ProductPageLocators.BASKET_MESSAGE), "Success message is presented, but should not be"

    def should_disappear(self):
        assert self.is_disappeared(*ProductPageLocators.BASKET_MESSAGE), "Success message not disappeared but should be"
